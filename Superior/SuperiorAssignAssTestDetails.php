...
<?php //echo "<form class='delete_button' action='.php?TestID=$row[TestID]&EmployeeID=$row[EmployeeID]&Question[]=$row[AQuestion]' method='POST'><button type='submit' title='Delete' name='AssignUserTestDel'><i class='fas fa-trash-alt'></i></button></form>"; ?>
