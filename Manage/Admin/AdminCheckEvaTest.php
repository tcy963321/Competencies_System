...
<center><table id="competency" class="w3-responsive" >
 ...
 <?php
   ...
   <tr>	
	...
	<td><?php echo "<form action='AdminViewEvaTest.php?TestID=$row[TestID]&EmployeeID=$row[Candidate]' method='POST'><button type='submit' name='Edit' title='View Question'><i class='fas fa-eye'></i></i></button></form>
	<form class='delete_button' action='Adminprocesscompetency.php?TestID=$row[TestID]& EmployeeID=$row[Candidate]' method='POST'><button type='submit' title='Delete' name='EvaTestDel'><i class='fas fa-trash-alt'></i></button></form>
	";?></td>
	</tr>
  <?php	} } ?>	 
</table></center>
