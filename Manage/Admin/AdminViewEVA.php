...
<tr>	
	...
	<td><?php echo "<form action='AdminViewEvaDetail.php?TestID=$row[TestID]&EmployeeID=$row[CandidateID]' method='POST'><button type='submit' name='Edit' title='View Question'><i class='fas fa-eye'></i></i></button></form>";?></td>
</tr>
  <?php	} } ?>						  
</table></center>
