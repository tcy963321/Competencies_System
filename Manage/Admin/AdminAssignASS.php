  ...
  <tr>
      ...
      <?php
                      ...
                      if($result){
                        ...
                        <tr>
							<td><input type="checkbox" name="chk[]" required value="<?php echo $row['A_QCode']; ?>|<?php echo $row['CodeCompetency']; ?>" /></td>
...
<table id="competency" style="display: none">
  <tr>
    <th><div class="dropdown">
		<button class="w3-bar-item w3-button">Select (<i class='fas fa-check'></i>)</button>
		<div class="dropdown-content">
...
<?php
  	...
  	<tr>
	<td>Test ID :</td>
	<td><input type="text" name="Testid[]" value="<?php echo EvaluateTestsetID()?>" readonly /></td>
	</tr>
      ...
      if (txtValue.toUpperCase().indexOf(filter) > -1) {
        ...
        tr[i].style.display = "none";
           ...
           function deSelect(){  
            ...
            function selectsall(){  
                var ele=document.getElementsByName('chkuser[]');  
                for(var i=0; i<ele.length; i++){  
                    if(ele[i].type=='checkbox')  
                        ele[i].checked=true;  
                }  
