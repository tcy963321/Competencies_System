...
<form action="" method="post" enctype="multipart/form-data">
  ...
  <legend>Update Competency Form:</legend>
			<table>
				...
				<tr>
				<td>Question :</td>		
				<td><textarea name="question" rows="4" cols="25"> <?php echo $row['AQuestion']; ?> </textarea></td>
				</tr>
				...
				<td><input type="radio" id="myRadio" name="group" value="Core Competencies" <?php echo $CC;?> readonly="readonly" /> Core Competencies</td>
				</tr>
				<tr><td></td>
				<td><input type="radio" id="myRadio2" name="group" value="Leading Other"  <?php echo $LO;?> readonly="readonly" /> Leading Other</td>
				</tr>
				<tr><td></td>
				<td><input type="radio" id="myRadio3" name="group" value="Organization Competencies"  <?php echo $OC;?> readonly="readonly" /> Organization Competencies</td>
				</tr>
				<tr><td></td>
				<td><input type="radio" id="myRadio4" name="group" value="Other" <?php echo $OtherGroup;?> readonly="readonly" /><input "type="text" name="othergroup" id="otherField" value="<?php echo $Other;?>" placeholder="Other" readonly /></td>
				</tr>
