...
<table>
<tr><td><input type="hidden" name="TestID[]" value="<?php echo $rows['TestID']; ?>"></input>Test ID: <?php echo $rows['TestID']; ?></td></tr>
<tr><td><input type="hidden" name="EmployeeID[]" value="<?php echo $rows['EmployeeID']; ?>"></input>Employee ID: <?php echo $rows['EmployeeID']; ?></td></tr>
<tr><td>Assign Time: <?php echo $rows['Assign_Time']; ?></td></tr>
</table></fieldset><br>
<?php
...
<tr><td><b>Competency Code: <?php echo $row ['CodeACompetency'] ; ?></i></b></td></tr>
