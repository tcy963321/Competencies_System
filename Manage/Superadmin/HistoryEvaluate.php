...
<div class="w3-container">
 ...
 <?php
   ...
   <tr>	
	...
	<td><?php echo "<form action='AssignEvaTestDetails.php?TestID=$row[TestID]&EmployeeID=$row[EmployeeID]' method='POST'><button type='submit' name='Edit' title='View Question'><i class='fas fa-eye'></i></i></button></form>";?></td>
	</tr>
  <?php	} } ?>	 
</table></center>
