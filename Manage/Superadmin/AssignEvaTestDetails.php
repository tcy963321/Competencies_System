...
<tr><td>Candidate ID: <?php echo $row['Candidate']; ?></td></tr>
...
<td><?php echo $row['QuestionCode']; ?></td>
<td><?php echo $row['Rating']; ?></td>
<td><?php echo $row['CodeACompetency']; ?></td>
<td><?php echo $row['Status']; ?></td>
<td><?php echo "<form action='EvamoreDetails.php?TestID=$row[TestID]&EmployeeID=$row[Candidate]&ECode=$row[CodeACompetency]&QCode=$row[QuestionCode]' method='POST' target='_blank'><button type='submit' name='Edit' title='View Question'><i class='fas fa-eye'></i></i>More>></button></form>";?></td>
