...
<td><?php echo "<form action='AssmoreDetails.php?TestID=$row[TestID]&EmployeeID=$row[EmployeeID]&ACode=$row[CodeACompetency]&QCode=$row[Question_Code]' method='POST' target='_blank'><button type='submit' name='Edit' title='View Question'><i class='fas fa-eye'></i></i>More>></button></form>";?></td>
</tr>
  <?php	} } ?>	
</fieldset>  
</table>
