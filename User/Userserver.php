...
if (isset($_POST['reg_user'])) {
  ...
  if (count($errors) == 0) { 
	...
	$query = "INSERT INTO login (Username, Password,  Roles) 
...
if (isset($_POST['login_user'])) {
  ...
  if (count($errors) == 0) {
  	$password = ($password);
  	$query = "SELECT * FROM login WHERE username='$username' AND Password='$password' AND Status='Activate' AND Roles='User'";
