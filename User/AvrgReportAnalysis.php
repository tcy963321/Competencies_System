...
?>
<tr><td><?php echo $row['CodeACompetency']; ?></td><td><?php echo $row['Competency']; ?></td><td><?php echo "$percentage"; ?>/<?php echo $row['Weightcompetency']; ?></td><td><?php echo "$percentage2"; ?>/<?php echo $row['Weightcompetency']; ?></td><td><?php echo "$totalmarks"; ?></td><td><?php echo "$level"; ?></td></tr>
<?php }}?>
</table>
</fieldset>
<fieldset>
