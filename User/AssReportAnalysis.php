...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-pale-red w3-animate-left w3-card" style="z-index:3;width:320px;" id="mySidebar">
  ...
  <a href="Report.php" class="w3-bar-item w3-button w3-border-bottom w3-large"><img src="imagesuploadedf/logo.png" style="width:60%;"></a>
    <a href="WelcomeUser.php" class="w3-bar-item w3-button w3-dark-grey w3-button w3-hover-black w3-left-align">Dashboard</a>
  <a href="Report.php" class="w3-bar-item w3-button"><i class="fa-file-word-o w3-margin-right"></i><b>Report Assessment</b></a>
...
<h4>TestID: <?php echo $rows['TestID']; ?></h4>
...
<br></br>
<hr></hr>
<h3>Bar Graph of Self-Assessment</h3>

<div class="w3-container w3-card w3-white w3-round w3-margin">
<div class="w3-row w3-container w3-responsive" style="margin:50px 0">
<div class="w3-half w3-container">
<div class="w3-topbar w3-border-orange">
<div id="columnchart_material" class="" style="width:800px; height:400px"></div>
</div>
</div>
<div class="w3-half w3-container">
<div class="w3-topbar w3-border-orange">
<div id="curve_chart" class="" style="width:800px; height:500px"></div>
</div>
</div>
</div>
<div class="w3-row w3-container w3-responsive" style="margin:50px 0">
<div class="w3-half w3-container">
<div class="w3-topbar w3-border-orange">
<div id="container" class="" style="width:800px; height:350px"></div>
</div>
</div>
<div class="w3-half w3-container">
<div class="w3-topbar w3-border-orange">
<div id="piechart" class="" style="width:800px; height:350px"></div>
</div>
</div>
</div>
</div>
