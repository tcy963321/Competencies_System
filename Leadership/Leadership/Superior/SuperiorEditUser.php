...
?>
			...
			<tr>
				...
				<td  class="left"><input type="text" name="education1" size="36" value="<?php  echo  $rows['Education1']; ?>" placeholder="eg: M.Sc" required id="my-field2" /></td>
			    </tr>
				
				<tr>
				<td class="td_1">Name of School 1:</td>
				<td  class="left"><input type="text" name="school1" size="36" value="<?php  echo  $rows['School1']; ?>" placeholder="Name of school" required id="my-field3" /></td>
			    </tr>
				
				<tr>
				<td class="td_1">Education 2 :</td>
				<td  class="left"><input type="text" name="education2" size="36" value="<?php  echo  $rows['Education2']; ?>" placeholder="eg: B.Sc. IT"  id="my-field4" /></td>
				</tr>
				
				<tr>
				<td class="td_1">Name of School 2:</td>
				<td  class="left"><input type="text" name="school2" size="36" value="<?php  echo  $rows['School2']; ?>" placeholder="Name of school" id="my-field5" /></td>
			    </tr>
			  
				<tr>
				<td class="td_1">Education 3 :</td>
				<td  class="left"><input type="text" name="education3" size="36" value="<?php  echo  $rows['Education3'];  ?>" placeholder="eg: STPM" id="my-field6"  /></td>
				</tr>
				
				<tr>
				<td class="td_1">Name of School 3:</td>
				<td  class="left"><input type="text" name="school3" size="36" value="<?php  echo  $rows['School3']; ?>" placeholder="Name of school" id="my-field7" /></td>
			    </tr>
			
				<tr>
				<td class="td_1">Specialized Field :</td>
				<td  class="left"><textarea name="field" placeholder="Specialized Field"  rows="2" cols="25" required id="my-field8" ><?php  echo  $rows['Field'];  ?></textarea></td>
				</tr>
