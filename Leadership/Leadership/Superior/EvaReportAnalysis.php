...
<script type="text/javascript" src="anychart-base.js"></script>
...
<br></br>
<center><h3 class="w3-opacity">Report Evaluate</h3></center>
<br></br>
<?php
    $results = EvaReportAnalysis();
        if($results){
        $rows = mysqli_fetch_assoc($results); ?>
<h4>Name: <?php echo $rows['Name']; ?></h4>
<h4>Employee ID: <?php echo $rows['CandidateID']; ?></h4>
...
<br></br>
<hr></hr>
<h3>Analysis of Evaluate</h3>
<div class="w3-row-padding w3-responsive" style="margin:0 -16px">
