...
<tr><td><?php echo"1. Evaluate Attempt Superior must answer all the question and no time limitation.</tr></td><tr><td>2.  Superior be honest to answer the questions. <button type='button'><a href='SuperiorStartEva.php?TestID=$row[TestID]&EmployeeID=$row[Candidate]' class='w3-bar-item w3-button' style='color:#633c05;'><b>Start Now</b></a></button></td></tr>";?>	
</div>
</table>
</fieldset>
