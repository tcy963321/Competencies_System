...
<form action="" method="post" enctype="multipart/form-data">
  ...
  <legend>Update Competency Form:</legend>
			<table>
				...
				<tr>
				<td>Question Code :</td>
				<td><input type="text" name="question_code" value="<?php echo $row['A_QCode']; ?>" required /></td>
				</tr>
			
				<tr>
				<td>Rating :</td>
				<td><input type="number" name="rating" value="<?php echo $row['Rating']; ?>" min="1" max="10" required /></td>
				</tr>
