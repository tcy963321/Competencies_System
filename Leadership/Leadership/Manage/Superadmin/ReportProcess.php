...
$db = mysqli_connect('localhost', 'root', '', 'leadercompetency');
    $sql = "SELECT DISTINCT TestID,EmployeeID,DateTime FROM aanswer";
    if($result = mysqli_query($db, $sql)){
        return $result;
    }		
}
...
$db = mysqli_connect('localhost', 'root', '', 'leadercompetency');
    $sql = "SELECT DISTINCT TestID,CandidateID,EmployeeID,DateTime FROM eanswer";
    if($result = mysqli_query($db, $sql)){
        return $result;
    }		
}
...
$db = mysqli_connect('localhost', 'root', '', 'leadercompetency');
$sql = "Select DISTINCT eanswer.TestID,eanswer.CandidateID,eanswer.EmployeeID FROM eanswer JOIN aanswer ON eanswer.TestID=aanswer.TestID";	
if($result = mysqli_query($db, $sql)){
return $result;
    }
}
