...
account.Email='$email',account.Department='$department',account.Position='$position' where account.EmployeeID=login.username AND EmployeeID='$id'"; 
   ...
   if($result&$result1)
   {
	...
	window.location.href = "SuperEditUser.php";
</script>';
   }
   mysqli_close($db);
}				
...
<!DOCTYPE html>
<html>
<title>Superadmin Edit User Profile</title>
<head>
...
<div class="tp-content">
	...
	<div class="tp-contentwrap1">
		<div class="left wt_25 side_1">
			...
			<div class="menu_list">
			<li><a href="Superadminadduser.php">Add User</a></li>
		...
		<div class="right wt_75">
			...
			<table>
				...
				<td  class="left"><input type="text" name="name" value="<?php  echo  $row['Name'];  ?>" placeholder="Name" required id="my-field2" maxlength="50" size="50"/></td>
			    </tr>
