...
account.Email='$email',account.Department='$department',account.Position='$position' where account.EmployeeID=login.username AND EmployeeID='$id'"; 
   ...
   if($result&$result1)
   {
    ...
    alert("Data Updated"); 
	window.location.href = "Superadmindisplayadmin.php";
</script>';
	...
	window.location.href = "SuperEditAdmin.php";
</script>';
   }
   mysqli_close($db);
}				
...
<!DOCTYPE html>
<html>
<title>Superadmin Edit Admin Profile</title>
<head>
...
<div class="tp-content">
	...
	<div class="tp-contentwrap1">
		<div class="left wt_25 side_1">
			...
			<li><a href="Superadmindisplayadmin.php">Display Admin</a></li>	
			</div>
		</div>

		<div class="right wt_75">
			<div class="tp-contentwrap2">
			<div class="strip-profile">Admin Info</div>
