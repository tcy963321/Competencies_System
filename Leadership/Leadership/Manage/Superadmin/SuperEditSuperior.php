...
account.Email='$email',account.Department='$department',account.Position='$position' where account.EmployeeID=login.username AND EmployeeID='$id'"; 
   ...
   if($result&$result1)
   {
	...
	window.location.href = "SuperEditSuperior.php";
</script>';
   }
   mysqli_close($db);
}				
...
<!DOCTYPE html>
<html>
<title>Superadmin Edit Superior Profile</title>
<head>
...
<div class="tp-content">
	...
	<div class="tp-contentwrap1">
		<div class="left wt_25 side_1">
			...
			<div class="menu_list">
			<li><a href="Superadminaddsuperior.php">Add Superior</a></li>
		...
		<div class="right wt_75">
			...
			<table>
				...
				<td  class="left"><input type="text" name="name" value="<?php  echo  $row['Name'];  ?>" placeholder="Name" required id="my-field3" maxlength="50" size="50"/></td>
			    </tr>
...
?>
				...
				<td  class="left"><input type="text" name="education1" size="36" value="<?php  echo  $rows['Education1']; ?>" placeholder="eg: M.Sc" required id="my-field4"" /></td>
			    </tr>
				
				<tr>
				<td class="td_1">Name of School 1:</td>
				<td  class="left"><input type="text" name="school1" size="36" value="<?php  echo  $rows['School1']; ?>" placeholder="Name of school" required id="my-field5" /></td>
			    </tr>
				
				<tr>
				<td class="td_1">Education 2 :</td>
				<td  class="left"><input type="text" name="education2" size="36" value="<?php  echo  $rows['Education2']; ?>" placeholder="eg: B.Sc. IT" id="my-field6" /></td>
				</tr>
				
				<tr>
				<td class="td_1">Name of School 2:</td>
				<td  class="left"><input type="text" name="school2" size="36" value="<?php  echo  $rows['School2']; ?>" placeholder="Name of school" id="my-field7" /></td>
			    </tr>
			  
				<tr>
				<td class="td_1">Education 3 :</td>
				<td  class="left"><input type="text" name="education3" size="36" value="<?php  echo  $rows['Education3'];  ?>" placeholder="eg: STPM" id="my-field8" /></td>
				</tr>
				
				<tr>
				<td class="td_1">Name of School 3:</td>
				<td  class="left"><input type="text" name="school3" size="36" value="<?php  echo  $rows['School3']; ?>" placeholder="Name of school" id="my-field9" /></td>
			    </tr>
			
				<tr>
				<td class="td_1">Specialized Field :</td>
				<td  class="left"><textarea name="field" placeholder="Specialized Field"  rows="2" cols="25" required id="my-field"><?php  echo  $rows['Field'];  ?></textarea></td>
				</tr>
				<tr>
