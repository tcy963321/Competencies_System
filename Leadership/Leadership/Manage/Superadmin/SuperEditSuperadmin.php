...
{
//"UPDATE account, login set login.Password='".$password."', account.image_url='$pic_url',account.Name='$name',account.IC='$ic',account.Contact_Number='$contact_number',account.Gender='$gender',account.Date_of_Birth='$dob',account.Address='$address',
...
account.Email='$email',account.Department='$department',account.Position='$position' where account.EmployeeID=login.username AND EmployeeID='$id'"; 
   ...
   if($result&$result1)
   {
    ...
    alert("Data Updated"); 
	window.location.href = "Superadmindisplay.php";
</script>';
	...
	window.location.href = "SuperEditSuperadmin.php";
</script>';
   }
   mysqli_close($db);
}				
...
<!DOCTYPE html>
<html>
<title>Superadmin Edit Superadmin Profile</title>
<head>
...
<div class="tp-content">
	...
	<div class="tp-contentwrap1">
		<div class="left wt_25 side_1">
			...
			<div class="menu_list">
			<li><a href="Superadminadd.php">Add Superadmin</a></li>
			<li><a href="Superadmindisplay.php">Display Superadmin</a></li>	
			</div>
		</div>

		<div class="right wt_75">
			<div class="tp-contentwrap2">
			<div class="strip-profile">Superadmin Info</div>
			<form action="" method="post" enctype="multipart/form-data">
			<table>
			    <tr>
				<td class="td_1">Name :</td>
				<td  class="left"><input type="text" name="name" value="<?php  echo  $row['Name'];  ?>" placeholder="Name" required id="my-field"  maxlength="50" size="50"/></td>
			    </tr>
...
?>
				...
				<td  class="left"><input type="text" name="position" value="<?php  echo  $row['Position'];  ?>" placeholder="Position" required id="my-field2" maxlength="50" size="50" /></td>
				</tr>
				...
				<td  class="left"><input type="text" name="roles" value="<?php  echo  $row['Roles'];  ?>" placeholder="Roles" onkeypress="return /[a-z]/i.test(event.key)" /></td>
				</tr>
				...
				<td  class="left"><input type="text" name="education1" size="36" value="<?php  echo  $rows['Education1']; ?>" placeholder="eg: M.Sc" required id="my-field3" /></td>
			    </tr>
				
				<tr>
				<td class="td_1">Name of School 1:</td>
				<td  class="left"><input type="text" name="school1" size="36" value="<?php  echo  $rows['School1']; ?>" placeholder="Name of school" required id="my-field4" /></td>
			    </tr>
				
				<tr>
				<td class="td_1">Education 2 :</td>
				<td  class="left"><input type="text" name="education2" size="36" value="<?php  echo  $rows['Education2']; ?>" placeholder="eg: B.Sc. IT" id="my-field5" /></td>
				</tr>
				
				<tr>
				<td class="td_1">Name of School 2:</td>
				<td  class="left"><input type="text" name="school2" size="36" value="<?php  echo  $rows['School2']; ?>" placeholder="Name of school" id="my-field6" /></td>
			    </tr>
			  
				<tr>
				<td class="td_1">Education 3 :</td>
				<td  class="left"><input type="text" name="education3" size="36" value="<?php  echo  $rows['Education3'];  ?>" placeholder="eg: STPM" id="my-field7" /></td>
				</tr>
				
				<tr>
				<td class="td_1">Name of School 3:</td>
				<td  class="left"><input type="text" name="school3" size="36" value="<?php  echo  $rows['School3']; ?>" placeholder="Name of school" id="my-field8" /></td>
			    </tr>
			
				<tr>
				<td class="td_1">Specialized Field :</td>
				<td  class="left"><textarea name="field" placeholder="Specialized Field"  rows="2" cols="25" required id="my-field9" ><?php  echo  $rows['Field'];  ?></textarea></td>
				</tr>
				<tr>
				<td  class="left"><input type="submit" name="submit" value="Update" onClick="validatePassword()" class="btn"/></td>
				</tr>
				</form>  
</table>
...
function testInput8(event) {
   var value = String.fromCharCode(event.which);
   var pattern = new RegExp(/[a-zåäö ]/i);
   return pattern.test(value);
}

$('#my-field8').bind('keypress', testInput8);


function testInput9(event) {
   var value = String.fromCharCode(event.which);
   var pattern = new RegExp(/[a-zåäö ]/i);
   return pattern.test(value);
}

$('#my-field9').bind('keypress', testInput9);
