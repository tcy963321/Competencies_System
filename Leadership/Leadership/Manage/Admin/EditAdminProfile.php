...
// store data in session variable through user
  ...
  $department =$_POST['department'];
   ...
   if($result)
   {
	...
	window.location.href = "EditAdminProfile.php";
</script>';
   }
   mysqli_close($db);
}				
		...
		<div class="right wt_75">
          ...
          $db1 = mysqli_connect('localhost', 'root', '', 'leadercompetency');
			...
			<table>
				...
				<td  class="left"><input type="text" name="name" value="<?php  echo  $row['Name'];  ?>" placeholder="Name" id="my-field" required  maxlength="50" size="50"/></td>
			    </tr>
				...
				<td class="left"><input type="text" id="txtfuturedate" class="datepicker" name="dob" value="<?php  echo  $row['Date_of_Birth'];  ?>" placeholder="dd/mm/yyyy" required /></td>
				</tr>
