...
account.Email='$email',account.Department='$department',account.Position='$position' where account.EmployeeID=login.username AND EmployeeID='$id'"; 
   ...
   if($result&$result1)
   {
	...
	window.location.href = "AdminEditSuperior.php";
</script>';
   }
   mysqli_close($db);
}				
...
<!DOCTYPE html>
<html>
<title>Admin Edit Superior Profile</title>
<head>
...
<div class="tp-content">
	...
	<div class="tp-contentwrap1">
		<div class="left wt_25 side_1">
			...
			<div class="menu_list">
			<li><a href="Adminaddsuperior.php">Add User</a></li>
			<li><a href="Admindisplaysuperior.php">Display User</a></li>	
			</div>
		</div>

		<div class="right wt_75">
			<div class="tp-contentwrap2">
			<div class="strip-profile">Superior Info</div>
