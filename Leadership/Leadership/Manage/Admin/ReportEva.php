...
<center>
<h2>Evaluate Report Lists</h2>
<br></br>
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Candidate ID...">
<table id="competency">
<tr>
						<th>Evaluator</th>
						<th>TestID</th>
...
<tr>
                            ...
                            <td><?php echo "<form action='EvaReportAnalysis.php?TestID=$row[TestID]&EmployeeID=$row[CandidateID]' method='POST'><button type='submit' name='Edit' title='View Report'><i class='fa fa-eye'></i></i></button></form>";?></td>
							</tr>
                   <?php
                           }
                       }
