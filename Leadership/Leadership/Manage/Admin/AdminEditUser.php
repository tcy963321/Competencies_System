	...
	<div class="tp-contentwrap1">
		...
		<div class="right wt_75">
			...
			<table>
				...
				<td  class="left"><input type="text" name="name" value="<?php  echo  $row['Name'];  ?>" placeholder="Name" required  maxlength="50" size="50" id="my-field" /></td>
			    </tr>
...
?>
				...
				<td  class="left"><input type="text" name="position" value="<?php  echo  $row['Position'];  ?>" placeholder="Position" required  maxlength="50" size="50" id="my-field2" /></td>
				</tr>
				
				<tr>
				<td class="td_1">Password :</td>
				<td  class="left"><input type="password" id="password" name="password" value="<?php  echo  $row['Password'];  ?>" placeholder="Password" pattern=".{8,12}" title="8 - 12 Character" size=30 pattern="[!@#$%^&*][a-z][A-Z][0-9]" required /><i class="far fa-eye" id="togglePassword"></i></td>
				</tr>
