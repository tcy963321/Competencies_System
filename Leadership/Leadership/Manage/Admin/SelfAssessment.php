...
<tr><td><?php echo"1. Assessment Attempt Candidate must answer all the question and no time limitation.</tr></td><tr><td>2.  Candidate be honest to answer the questions. <button type='button'><a href='AdminAssessment.php?TestID=$row[TestID]&EmployeeID=$row[EmployeeID]' class='w3-bar-item w3-button' style='color:#633c05;'><b>Start Now</b></a></button></td></tr>";?>	
</div>
</table>
</fieldset>
