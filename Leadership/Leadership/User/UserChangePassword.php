    ...
    <form name="frmChange" method="post" action="" onSubmit="return validatePassword()">
            <table>
                ...
                <td class="left"><input type="password" name="newPassword"
                    class="txtField" required id="password2" pattern=".{8,12}" title="8 - 12 Character" size=30 pattern="[!@#$%^&*][a-z][A-Z][0-9]" /><span 
                ...
                <td class="left"><input type="password" name="confirmPassword"
                    class="txtField" required id="password3" pattern=".{8,12}" title="8 - 12 Character" size=30 pattern="[!@#$%^&*][a-z][A-Z][0-9]" /><span 
