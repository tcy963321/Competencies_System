...
<div class="tp-content">
	...
	<div class="tp-contentwrap1">
		...
		<div class="right wt_75">
			...
			<div class="strip-profile">Educational Information</div>
			<form action="" method="post" enctype="multipart/form-data">
			<table>
			    <tr>
				<td class="td_1">Education 1 :</td>
				<td  class="left"><input type="text" name="education1" id="my-field" size="36" value="<?php  echo  $rows['Education1']; ?>" placeholder="eg: M.Sc" required /></td>
			    </tr>
				
				<tr>
				<td class="td_1">Name of School 1:</td>
				<td  class="left"><input type="text" name="school1" id="my-field2" size="36" value="<?php  echo  $rows['School1']; ?>" placeholder="Name of school" required  /></td>
			    </tr>
				
				<tr>
				<td class="td_1">Education 2 :</td>
				<td  class="left"><input type="text" name="education2" id="my-field3" size="36" value="<?php  echo  $rows['Education2']; ?>" placeholder="eg: B.Sc. IT"  /></td>
				</tr>
				
				<tr>
				<td class="td_1">Name of School 2:</td>
				<td  class="left"><input type="text" name="school2" id="my-field4" size="36" value="<?php  echo  $rows['School2']; ?>" placeholder="Name of school"  /></td>
			    </tr>
			  
				<tr>
				<td class="td_1">Education 3 :</td>
				<td  class="left"><input type="text" name="education3" id="my-field5" size="36" value="<?php  echo  $rows['Education3'];  ?>" placeholder="eg: STPM"  /></td>
				</tr>
				
				<tr>
				<td class="td_1">Name of School 3:</td>
				<td  class="left"><input type="text" name="school3" id="my-field6" size="36" value="<?php  echo  $rows['School3']; ?>" placeholder="Name of school"  /></td>
			    </tr>
			
				<tr>
				<td class="td_1">Specialized Field :</td>
				<td  class="left"><textarea name="field" placeholder="Specialized Field" id="my-field7"  rows="2" cols="25" required ><?php  echo  $rows['Field'];  ?></textarea></td>
				</tr>
				<tr>
